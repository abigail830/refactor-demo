...
class StatementServiceTest {
    ...
    @Test
    void printStatement_CHILDREN_4days_and_REGULAR_3days_and_NEW_RELEASE_1day() {
        //given
        final Customer customer1 = new Customer("customer1");
        ...
        final Movie movie2 = new Movie("movie2", Movie.REGULAR);
        customer1.addRental(new Rental(movie2, 3));

        final Movie movie3 = new Movie("movie3", Movie.NEW_RELEASE);
        customer1.addRental(new Rental(movie3, 1));
